...
urlpatterns = [
    ...
    re_path('^proabc$', views.proabc, name='proabc'),

    # admin login
    re_path('admin_login/', views.admin_login, name='admin_login'),
    re_path('adminDash/deleteprofile/<int:id>/',
    ...
    re_path('mainplatform/editplatform/<int:id>/',
            views.editplatform, name='editplatform'),


    # update platform
    re_path('mainplatform/editplatform/updateplatform/<int:id>/',
            views.updateplatform, name='updateplatform'),

    # delete platform
    re_path('mainplatform/deleteplatform/<int:id>/',
    ...
    # display platform
    re_path('viewprojectdetail/', views.viewprojectdetail,
    ...
    re_path('userprojects/<int:id>', views.userpythonprojects,
            name='userpythonprojects'),

    re_path('adminprojectsview/<int:id>',
            views.adminprojectsview, name='adminprojectsview'),

    #not working
    re_path('userandroidprojects/', views.userandroidprojects,
            name='userandroidprojects'),
    re_path('usermlprojects/', views.usermlprojects, name='usermlprojects'),

    # display project details
    re_path('userviewpython/<int:id>',
            views.userviewpython, name='userviewpython'),

    # save user request project
    re_path('userreqprojects/userreqprojectdb/',
            views.userreqprojectdb, name='userreqprojectdb'),

    # delete projects
    re_path('viewprojectdetail/deleteprojects/<int:id>/',
            views.deleteprojects, name='deleteprojects'),

    # save project details
    re_path('addproject/addnewprojectdb/',
            views.addnewprojectdb, name='addnewprojectdb'),

    # save platform details
    re_path('platform/addnewplatformdb/',
            views.addnewplatformdb, name='addnewplatformdb'),

    #not working
    re_path('viewmlproject/<int:id>',
            views.viewmlproject, name='viewmlproject'),
    re_path('viewandroidproject/<int:id>',
            views.viewandroidproject, name='viewandroidproject'),
    re_path('takeDiversion/<str:name>',
            views.ProjectDiverter, name='takeDiversion'),
    re_path('viewmlprojects/', views.viewmlprojects, name='viewmlprojects'),
    re_path('viewandroidprojects/', views.viewandroidprojects,
    ...
    re_path('show_inbuiltproject_requests/',
            views.show_inbuiltproject_requests, name='show_inbuiltproject_requests'),
    ...
    re_path('view_ieee_papers/<int:id>',
            views.view_ieee_papers, name='view_ieee_papers'),

    re_path('ieee_search/', views.ieee_search, name='ieee_search'),

    re_path('user_req_ieee_projects/<int:id>',
            views.user_req_ieee_projects, name='user_req_ieee_projects'),
    ...
    re_path('user_req_inbuilt_projectdb/',
            views.user_req_inbuilt_projectdb, name='user_req_inbuilt_projectdb'),
    ...
    re_path('delvediotutorial/<int:id>',
            views.delvediotutorial, name='delvediotutorial'),
    ...
    re_path('editplatform/<int:platformid>',
            views.editplatform, name='editplatform'),
    re_path('updateplatform/<int:platformid>',
            views.updateplatform, name='updateplatform'),
    re_path('deleteplatform/<int:platformid>',
            views.deleteplatform, name='deleteplatform'),
    # Courses
    ...
    re_path('updatecourse/<int:courseid>',
            views.updatecourse, name='updatecourse'),
    re_path('deletecourse/<int:courseid>',
    ...
    re_path('editlecture/<int:lectureid>/',
            views.editlecture, name='editlecture'),
    re_path('updatelecture/<int:lectureid>',
            views.updatelecture, name='updatelecture'),
    re_path('deletelecture/<int:lectureid>',
            views.deletelecture, name='deletelecture'),
    ...
    re_path('editquestionpage/<int:qandaid>',
            views.editquestionpage, name='editquestionpage'),
    re_path('updatequestion/<int:qandaid>',
            views.updatequestion, name='updatequestion'),
    re_path('deletequestionanswer/<int:qandaid>',
            views.deletequestionanswer, name='deletequestionanswer'),
    ...
    re_path('tutorialview/<int:lectureid>',
            views.tutorialview, name='tutorialview'),
    re_path('userlogout', views.userlogout, name='userlogout'),
    re_path('edituserprofile', views.edituserprofile, name='edituserprofile'),
    re_path('updateuserprofile', views.updateuserprofile,
